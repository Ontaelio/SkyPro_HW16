"""
A test program for APIs.
I prefer to run it from IDLE/command prompt to emulate external server access
(i.e. no venv present)
Posts new items, puts them and deletes, the table remains as it was before.
To check uniqueness of unique values, comment out delete tests and run twice
"""
